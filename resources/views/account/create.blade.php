            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">  
                    <div class="p-6 bg-white  md:justify-between md:items-center">
                        ...
                        <form class="md:w-1/2 space-y-5" action="{{route('account.store')}}" method="POST">
                            @csrf
                            <div>
                            ...
                            <div> 
                                ...
                                <select name="coin_id" id="coin_id" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full">
