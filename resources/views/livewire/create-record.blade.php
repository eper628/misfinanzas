<form class="md:w-1/2 space-y-5" wire:submit.prevent='crearRecord'>
    <div>
    ...
    <div>
        ...
        <select id="category_id" wire:model="category_id" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full">
